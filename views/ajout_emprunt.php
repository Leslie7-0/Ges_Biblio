...
<body>
    ...
    <main>
        ...
        <form class="form-container" action="index.php?action=ajouter_emprunt" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="prenom_membre" name="prenom_membre" required readonly>
            </div>
            <div class="form-group">
                <label for="email_membre">Email Membre:</label>
                <input type="email" id="email_membre" name="email_membre" required readonly>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="auteur_oeuvre" name="auteur_oeuvre" required readonly>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" id="limit_emprunt" name="limit_emprunt" required>
            </div>
